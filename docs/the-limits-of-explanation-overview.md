...
| Ostrowski | 455 | 10 | Bilemma, tightness classification, enrichment stack, physics |
| **Total** | **1,313** | **41** | **0 sorry** |
...
**Formally verified.** Among major impossibility theorems in science, almost none have been machine-checked as part of the original contribution. 1,313 theorems across 3 repos with 0 sorry tactics.
