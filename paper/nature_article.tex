...
sacrificed---maps onto the structure of paradigm shifts. The transition
...
(Table~\ref{tab:revolutions}). Whether paradigm shifts \emph{in general}
follow the enrichment pattern is a conjecture supported by five formalized
instances.
