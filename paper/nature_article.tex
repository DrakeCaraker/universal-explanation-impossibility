...
The historical timeline of this convergence underscores its independence:
gauge invariance in physics dates to Weyl in the 1920s; the
microcanonical ensemble to Boltzmann in the 1870s; Patterson maps in
crystallography to the 1930s; the pseudoinverse in mathematics to
Penrose in 1955; codon usage tables in biology to the 1960s following the
cracking of the genetic code; CPDAGs in statistics to Verma and Pearl in
1990; packed parse forests in linguistics to the 1980s; and complement
views in database theory to Bancilhon and Spyratos in 1981.  These
developments span more than a century, across fields with no shared
literature and no awareness of one another's resolutions.  A physicist
developing gauge-invariant observables was not reading the crystallography
literature on Patterson maps; a statistician constructing CPDAGs was not
drawing on the theory of codon usage tables.  The convergence occurred
because the mathematical structure forced it, not because of intellectual
cross-pollination.
