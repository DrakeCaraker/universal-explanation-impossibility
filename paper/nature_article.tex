...
Lean~4 proof assistant (99~files, 436~theorems, 0~unproved goals).
...
is mechanically verified in Lean~4~\citep{demoura2021lean4} (99~files,
436~theorems, 0~unproved goals) and empirically validated in seven domains
...
importance comparisons are unreliable.
...
using Mathlib~\citep{mathlib2020}: 99~files, 436~theorems, 0~unproved
