...
\citet{hauptman1985} shared the 1985 Nobel Prize in Chemistry for developing
direct methods that partially recover the phases, but the fundamental
ambiguity remains.

\paragraph{The explanation system.}
We formalize the simplest case: a 2-element discrete signal.
...
Mann-Whitney $p < 10^{-57}$ per signal length).
...
action.  Modern direct methods \citep{hauptman1985} go further by exploiting
