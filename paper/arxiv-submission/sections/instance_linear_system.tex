...
Five solvers (pseudoinverse, LSQR, Tikhonov, random null-space) applied to 100
underdetermined systems show mean pairwise RMSD of 0.091, compared to 0.049 for
fully determined controls (Mann-Whitney $p = 6.3 \times 10^{-9}$).  Disagreement is elevated across all null space
dimensions $d > 0$.
