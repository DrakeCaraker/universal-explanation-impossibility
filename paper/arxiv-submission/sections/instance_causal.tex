...
orientation agreement of only 0.33 (Mann-Whitney $p = 2.4 \times 10^{-5}$ across 10 random seeds per condition).  At $N = 100{,}000$, all algorithms
converge to the same CPDAG with orientation agreement~1.0, confirming that
finite-sample ambiguity (not algorithmic limitation) drives the disagreement.
