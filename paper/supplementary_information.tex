...
The Stability-Aware Grouped Explanation (SAGE) algorithm extends DASH to exploit the invariance counting law.  Given $P$ features in $g$ dependence groups (identified via correlation for continuous features; the exact boundary is $I(X_j; X_k) > 0$), SAGE:
