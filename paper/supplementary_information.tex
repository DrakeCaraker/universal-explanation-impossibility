...
The Lean~4 formalization (v4.30.0-rc1 with Mathlib) comprises 99 files containing 436 theorems and lemmas, 72 axioms, and 0 \texttt{sorry} (unproved goals).  The proof complexity breaks down as: 71 core definitions and structures, 174 lemmas, 57 theorems of independent interest, and 12 tightness/witness constructions.
