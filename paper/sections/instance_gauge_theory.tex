...
concentrates near the ordered ground state (small Rashomon set).  The MC
measurements match the exact analytic predictions to within statistical
error, confirming the dose-response is a genuine physical effect.
