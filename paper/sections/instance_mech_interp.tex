...
Complementary evidence comes from \citet{sae_seeds_2025}, who show that
...
This is verified in Lean~4 as \texttt{mech\_interp\_impossibility} in
\texttt{MechInterpInstance.lean} (three type axioms: \texttt{CircuitConfig},
\texttt{CircuitExplanation}, \texttt{CircuitObservable}, plus the
