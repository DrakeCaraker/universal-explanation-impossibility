\begin{table}[t]
\centering
\caption{Token Citation Instability (Attention-Based Citation).
...
\midrule
\multicolumn{3}{l}{\emph{Negative control (26 easy sentences: top quartile by Jaccard consensus)}} \\
Citation overlap (Jaccard) & 1.000 & [1.000, 1.000] \\
Flip rate & 0.315 & [0.289, 0.343] \\
\midrule
\multicolumn{3}{l}{\emph{Resolution test (consensus top-3 vs individual top-3)}} \\
Consensus overlap (Jaccard) & 0.857 & [0.842, 0.871] \\
\bottomrule
\end{tabular}
\end{table}
