...
\input{sections/table_gradcam}

\paragraph{Moderate instability compared to attention.}
The 9.6\% peak flip rate for GradCAM is substantially lower than the 19.9\%
full-retraining argmax flip rate for attention maps (Section~\ref{sec:instance-attention}).
