...
in the Lean~4 proof assistant (95~files, 417~theorems, 0~unproved goals),
...
\citep{demoura2021lean4} (95~files, 417~theorems, 0~unproved goals).
...
Mathlib \citep{mathlib2020}.  The formalization comprises 95~files,
417~theorems and lemmas, 72~axioms (all domain-specific; the core theorem
