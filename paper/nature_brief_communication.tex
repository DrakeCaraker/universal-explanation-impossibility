...
in the Lean~4 proof assistant (93~files, 408~theorems, 0~unproved goals),
...
\citep{demoura2021lean4} (93~files, 408~theorems, 0~unproved goals).
...
Mathlib \citep{mathlib2020}.  The formalization comprises 93~files,
408~theorems and lemmas, 72~axioms (all domain-specific; the core theorem
