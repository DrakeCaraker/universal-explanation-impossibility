...
aggregation.  More broadly, the severity of the impossibility and the
structure of the available resolutions are parameterized by the symmetry
group of the equivalence class---connecting explainability to the
representation theory of groups, with a hierarchy from abelian (unique
canonical resolution) through non-abelian (resolution multiplicity) to
non-compact (resolution divergence requiring regularization).
