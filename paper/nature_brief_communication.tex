...
in the Lean~4 proof assistant (87~files, 390~theorems, 0~unproved goals),
...
\citep{demoura2021lean4} (87~files, 390~theorems, 0~unproved goals).
...
Mathlib \citep{mathlib2020}.  The formalization comprises 87~files,
390~theorems and lemmas, 72~axioms (all domain-specific; the core theorem
