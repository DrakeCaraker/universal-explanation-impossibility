...
in the Lean~4 proof assistant (84~files, 381~theorems, 0~unproved goals),
...
\citep{demoura2021lean4} (84~files, 381~theorems, 0~unproved goals).
...
Mathlib \citep{mathlib2020}.  The formalization comprises 84~files,
381~theorems and lemmas, 72~axioms (all domain-specific; the core theorem
