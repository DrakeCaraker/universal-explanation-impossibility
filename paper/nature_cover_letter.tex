...
($G$-invariant projection) is Pareto-optimal within correlation groups
(Lean-verified; global optimality argued).  The entire
formal framework is mechanically verified in the Lean~4 proof
assistant (\ClaimMainTheorems~theorems, 0~unproved goals).
