...
echo "== 2/5 tex -> Lean reference lint"
python3 "$MAIN/paper/scripts/lint_tex_lean_refs.py" \
  "$MAIN/paper/universal_impossibility_monograph.tex" \
  "$MAIN/paper/nature_article.tex" \
  "$MAIN/paper/universal_impossibility_jmlr.tex" \
  "$MAIN/paper/universal_impossibility_neurips.tex" \
  "$MAIN/paper/supplementary_information.tex" \
