...
structural tradeoff. The necessity result (Proposition~\ref{prop:necessity})
...
impossibility theorem~\cite{arrow1951social} in social choice. Our result provides a
...
evidence'' documenting model decisions. Fairness regulations face
a parallel impossibility: Chouldechova~\cite{chouldechova2017fair} proved
that common fairness metrics cannot simultaneously be satisfied when base
rates differ across groups. Both implicitly demand
