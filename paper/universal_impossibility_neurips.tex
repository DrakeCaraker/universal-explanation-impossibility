...
The framework is mechanically verified in Lean~4 (93~files, 408~theorems, 72~axioms, 0~\texttt{sorry}).
\end{abstract}
...
(6)~Lean~4 formalization: 93~files, 408~theorems, 72~axioms, 0~\texttt{sorry}.
