...
The framework is mechanically verified in Lean~4 (96~files, 424~theorems, 72~axioms, 0~\texttt{sorry}).
\end{abstract}
...
(6)~Lean~4 formalization: 96~files, 424~theorems, 72~axioms, 0~\texttt{sorry}.
