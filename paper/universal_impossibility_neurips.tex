...
The framework is mechanically verified in Lean~4 (75~files, 351~theorems, 72~axioms, 0~\texttt{sorry}).
\end{abstract}
...
(6)~Lean~4 formalization: 75~files, 351~theorems, 72~axioms, 0~\texttt{sorry}.
