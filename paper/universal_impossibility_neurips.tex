...
The framework is mechanically verified in Lean~4 (83~files, 378~theorems, 72~axioms, 0~\texttt{sorry}).
\end{abstract}
...
(6)~Lean~4 formalization: 83~files, 378~theorems, 72~axioms, 0~\texttt{sorry}.
