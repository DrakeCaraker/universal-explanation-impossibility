...
The framework is mechanically verified in Lean~4 (87~files, 390~theorems, 72~axioms, 0~\texttt{sorry}).
\end{abstract}
...
(6)~Lean~4 formalization: 87~files, 390~theorems, 72~axioms, 0~\texttt{sorry}.
