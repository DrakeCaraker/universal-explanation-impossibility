...
The framework is mechanically verified in Lean~4 (94~files, 411~theorems, 72~axioms, 0~\texttt{sorry}).
\end{abstract}
...
(6)~Lean~4 formalization: 94~files, 411~theorems, 72~axioms, 0~\texttt{sorry}.
