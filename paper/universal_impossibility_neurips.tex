...
The framework is mechanically verified in Lean~4 (107~files, 493~theorems, 83~axioms, 0~\texttt{sorry}).
\end{abstract}
...
(6)~Lean~4 formalization: 107~files, 493~theorems, 83~axioms, 0~\texttt{sorry}.
