...
The framework is mechanically verified in Lean~4 (103~files, 455~theorems, 72~axioms, 0~\texttt{sorry}).
\end{abstract}
...
(6)~Lean~4 formalization: 103~files, 455~theorems, 72~axioms, 0~\texttt{sorry}.
