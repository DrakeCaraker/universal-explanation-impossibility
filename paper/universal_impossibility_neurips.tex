...
The framework is mechanically verified in Lean~4 (102~files, 442~theorems, 72~axioms, 0~\texttt{sorry}).
\end{abstract}
...
(6)~Lean~4 formalization: 102~files, 442~theorems, 72~axioms, 0~\texttt{sorry}.
