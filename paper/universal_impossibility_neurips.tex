...
The framework is mechanically verified in Lean~4 (95~files, 417~theorems, 72~axioms, 0~\texttt{sorry}).
\end{abstract}
...
(6)~Lean~4 formalization: 95~files, 417~theorems, 72~axioms, 0~\texttt{sorry}.
