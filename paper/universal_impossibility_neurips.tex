...
The framework is mechanically verified in Lean~4 (84~files, 381~theorems, 72~axioms, 0~\texttt{sorry}).
\end{abstract}
...
(6)~Lean~4 formalization: 84~files, 381~theorems, 72~axioms, 0~\texttt{sorry}.
