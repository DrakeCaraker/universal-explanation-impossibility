...
The framework is mechanically verified in Lean~4 (104~files, 463~theorems, 72~axioms, 0~\texttt{sorry}).
\end{abstract}
...
(6)~Lean~4 formalization: 104~files, 463~theorems, 72~axioms, 0~\texttt{sorry}.
