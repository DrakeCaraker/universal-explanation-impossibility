...
The framework is mechanically verified in Lean~4 (82~files, 377~theorems, 72~axioms, 0~\texttt{sorry}).
\end{abstract}
...
(6)~Lean~4 formalization: 82~files, 377~theorems, 72~axioms, 0~\texttt{sorry}.
