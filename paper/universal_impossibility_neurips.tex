...
The framework is mechanically verified in Lean~4 (91~files, 402~theorems, 72~axioms, 0~\texttt{sorry}).
\end{abstract}
...
(6)~Lean~4 formalization: 91~files, 402~theorems, 72~axioms, 0~\texttt{sorry}.
