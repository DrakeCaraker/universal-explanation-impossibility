...
counts: ## Show current theorem/axiom/sorry/file counts
	...
	@echo "Expected:        100 files / 491 theorems+lemmas / 25 axioms / 0 sorry"

verify: counts ## Verify Lean builds + counts are consistent (target: 100/491/25/0)
	@echo ""
...
.PHONY: ci
ci: ## Consistency CI: claims freshness, tex-Lean lint, 3x lake build, axiom audit, sorry audit
	bash paper/scripts/ci.sh
