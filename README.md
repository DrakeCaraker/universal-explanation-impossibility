...
Three repositories, 1,156 theorems total, **0 sorry**:
...
| [ostrowski-impossibility](https://github.com/DrakeCaraker/ostrowski-impossibility) | 21 | 298 | 10 | Bilemma, tightness classification, enrichment stack, physics application |
...
| Lean theorems (total) | 1,156 across 3 repos | 0 sorry |
...
@article{caraker2026limits,
  ...
  year    = {2026},
  note    = {Lean 4 formalization: 1,156 theorems, 0 sorry}
}
```
